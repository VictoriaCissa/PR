...
/**
 * Created by Alexandr on 29.04.2017.
 */
public class GUIForm implements IForm {
    ...
    public GUIForm() {
        prepareMailTable();
        prepareWebView();
        receiver = new Client("second@vika.cissa", "vikusik", this);
        sender = new Sender("first@vika.cissa", this);
        send.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (file == null)
                    sender.send(subject.getText(), msgArea.getText());
                else
                    sender.send(subject.getText(), msgArea.getText(), file);
            }
        });
        ...
        attach.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    attachStat.setText(selectedFile.getName());
                    file = selectedFile;
                    System.out.println("SELECTED FILE " + file.getAbsolutePath());
                } else {
                    file = null;
                    attachStat.setText("Nothing attached");
                }
            }
        });
